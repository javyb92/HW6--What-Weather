$(document).ready(function() {
  ...
  function getDataUpdateHTML(city) {
    ...
    $.ajax({url: query5dayURL, method: "GET"}).then(function (response) {
      ...
      $("#forcastday1").html("<p>" +"Tomorrow"+"</p>" + "<img src="+ "http://openweathermap.org/img/w/" + response.list[0].weather[0].icon + ".png>" + "<p>"+ "Hi "  + Math.ceil(response.list[0].main.temp_max) + " / Lo "+ Math.ceil(response.list[0].main.temp_min)+ "</p>" + "<p>"+"Humidity "+ response.list[0].main.humidity + "%"+"</p>");
      $("#forcastday2").html("<p>" + response.list[8].dt_txt + "</p>" + "<img src="+ "http://openweathermap.org/img/w/" + response.list[8].weather[0].icon + ".png>" + "<p>"+ "Hi "  + Math.ceil(response.list[8].main.temp_max)  +  "</p>" + "<p>"+"Humidity " + response.list[8].main.humidity + "%"+"</p>");
      $("#forcastday3").html("<p>" + response.list[16].dt_txt + "</p>" + "<img src="+ "http://openweathermap.org/img/w/" + response.list[16].weather[0].icon + ".png>" + "<p>"+ "Hi " + Math.ceil(response.list[16].main.temp_max) + "</p>" + "<p>"+"Humidity "  + response.list[16].main.humidity + "%"+"</p>");
      $("#forcastday4").html("<p>" + response.list[24].dt_txt + "</p>" + "<img src="+ "http://openweathermap.org/img/w/" + response.list[24].weather[0].icon + ".png>" +"<p>" + "Hi "+ Math.ceil(response.list[24].main.temp_max) +  "</p>" + "<p>"+"Humidity " + response.list[24].main.humidity + "%"+"</p>");
      $("#forcastday5").html("<p>" + response.list[32].dt_txt + "</p>" + "<img src="+ "http://openweathermap.org/img/w/" + response.list[32].weather[0].icon + ".png>" + "<p>"+ "Hi " + Math.ceil(response.list[32].main.temp_max) +  "</p>" + "<p>"+"Humidity " + response.list[32].main.humidity + "%"+"</p>");         
